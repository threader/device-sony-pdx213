...
include device/sony/lena/PlatformConfig.mk

TARGET_BOOTLOADER_BOARD_NAME := unknown
ifneq (,$(filter %xqbt52,$(TARGET_PRODUCT)))
TARGET_BOOTLOADER_BOARD_NAME := XQ-BT52
else
TARGET_BOOTLOADER_BOARD_NAME := XQ-BT52
...
# Reserve space for data encryption (112111374336-16384)
BOARD_USERDATAIMAGE_PARTITION_SIZE := 112111357952
